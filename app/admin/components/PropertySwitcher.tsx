    ...
    <form action={formAction} className="px-3 pb-1">
      ...
      <div className="relative">
        ...
        <select
          ...
          className="w-full appearance-none bg-emerald-50 border border-emerald-100 rounded-xl pl-8 pr-2 py-2 text-xs text-slate-700 hover:border-emerald-300 focus:border-emerald-400 focus:outline-none disabled:opacity-60 cursor-pointer"
        >
          {properties.map((p) => (
